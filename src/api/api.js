...
const updatePlayer = (playerId, payload) => {
  const response = axios
    .patch("/api/players/" + playerId, payload)
    .catch(err =>
      console.log("oh shit, update player failed", err.response.data)
    );
...
const updateGame = (gameId, payload) => {
  axios
    ...
    .catch(err =>
      console.log("oh shit, update game failed", err.response.data)
    );
};

const sendPayment = (gameId, payload) => {
  const response = axios
    .post(`/api/games/${gameId}/payment`, payload)
...
const updateDeposit = (playerId, payload) => {
  const response = axios
    .post("/api/players/" + playerId + "/deposit", payload)
...
const freeParkingAdd = (gameId, payload) => {
  const response = axios
    .post(`/api/games/${gameId}/freeparkingadd`, payload)
...
const freeParkingSplit = (gameId, payload) => {
  const response = axios
    .post(`/api/games/${gameId}/freeparkingsplit`, payload)
